...
namespace BuscaCEP.WSCorreios {
    ...
    public partial class AtendeClienteClient : System.ServiceModel.ClientBase<BuscaCEP.WSCorreios.AtendeCliente>, BuscaCEP.WSCorreios.AtendeCliente {
        ...
        public BuscaCEP.WSCorreios.enderecoERP consultaCEP(string cep, string usuario, string senha) {
        ...
        public System.Threading.Tasks.Task<BuscaCEP.WSCorreios.consultaCEPResponse> consultaCEPAsync(string cep, string usuario, string senha) {
            BuscaCEP.WSCorreios.consultaCEP inValue = new BuscaCEP.WSCorreios.consultaCEP();
            inValue.cep = cep;
            inValue.usuario = usuario;
            inValue.senha = senha;
